export const skillsData = [
  {
    ...
    tags: ['html5', 'css3', 'javascript', 'tailwindCss', 'react', 'netlify', 'affinityDesign', 'motion', 'rechart'],
  ...
  },
  {
    ...
    tags: ['nodejs', 'mySql', 'postgresql', 'apache', 'aws', 'cloudflare', 'express'],
    img: './img/backend.gif',
    id: 2,
  },
  {
    ...
    tags: ['git', 'vscode', 'gitHub', 'aws', 'cloudflare', 'msOffice', 'chatGpt'],
    img: './img/skills.gif',
    id: 3,
  },
];
...
export const chartLevels = ['Beginner', 'Learning', 'Intermediate', 'Proficient', 'Advanced', 'Expert'];
